...
def create_resting_state_graphs(allocated_memory = None,
                                wf_name = 'graph_centrality',
                                multipleTemplate=False):
    '''
    ...
    if (multipleTemplate):
        calculate_centrality = pe.MapNode(util.Function(input_names = ['datafile',
                                                                'template',
                                                                'method_option',
                                                                'threshold_option',
                                                                'threshold',
...
def get_zscore(input_name, wf_name = 'z_score'):
    ...
    mean = pe.MapNode(interface=fsl.ImageStats(),
                    name='mean', iterfield=['in_file', 'mask_file'])
    ...
    z_score = pe.MapNode(interface=fsl.MultiImageMaths(),
                        name='z_score',
                        iterfield=['in_file', 'op_string', 'operand_files'])
